...
export default function AgorasTermsPage() {
  return (
      ...
      <Section overflowVisible>
        <div className="termspriv">
          ...
          <ul>
            ...
            <li>
              <p>
                <strong>Country</strong> refers to: Venezuela
              </p>
            </li>
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to Agoras.
              </p>
            </li>
          ...
          <p>
            ...
            contact us at{" "}
            <a href="https://github.com/LuisAlejandro/agoras/issues">
              github.com/LuisAlejandro/agoras/issues
            </a>
            .
          </p>
        </div>
