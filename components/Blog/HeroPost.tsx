...
import DeferredCommentCount from "./DeferredCommentCount";
  ...
  return (
    <div id="featured" className={`flex w-[94%] mx-auto ${className}`}>
      <article className={`${type} w-full p-0 m-0`} id={`post-${id}`}>
        ...
        <div className="bg relative inline-block align-top w-1/2 h-[350px] p-0 m-0 rounded-none overflow-hidden">
          <Image
            src={coverImage.url}
            alt={title}
            fill
            priority
            sizes="(max-width: 640px) 94vw, (max-width: 1024px) 94vw, 47vw"
