...
const BackgroundAnimation = () => {
  ...
  useEffect(() => {
    ...
    const movePortfolio = function(x, y) {
      ...
      el.style.transform= `translate(${(10 * portfolioPos.x) + 0}px, ${(10 * portfolioPos.y) + 0}px) rotateZ(30deg)`;
    }
    ...
    const moveBlog = function(x, y) {
      ...
      el.style.transform= `translate(${(30 * blogPos.x) - 450}px, ${(30 * blogPos.y) + 50}px) rotateZ(-30deg)`;
    }
    ...
    const moveContact = function(x, y) {
      ...
      el.style.transform= `translate(${(-10 * donationsPos.x) - 450}px, ${(-10 * donationsPos.y) - 300}px) rotateZ(-50deg)`;
    }
    ...
    const moveEaster = function(x, y) {
      ...
      el.style.transform= `translate(${(-20 * easterPos.x) - 250}px, ${(-20 * easterPos.y) + 250}px) rotateZ(20deg)`;
    }
    ...
    const moveDonations = function(x, y) {
      ...
      el.style.transform= `translate(${(-30 * contactPos.x) + 0}px, ${(10 * contactPos.y) + 100}px) rotateZ(150deg)`;
    }
