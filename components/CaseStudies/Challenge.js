...
const Challenge = ({ Title, Content }) => (
  <div id="challenge" className="w-full bg-gradient-to-tl from-orange-500 to-yellow-300">
    ...
    <Scene triggerElement="#challenge" duration="200%" triggerHook="1">
      {progress => (
        <Tween
          ...
          paused>
          <h1 className="font-display text-18xl font-bold text-white m-0 absolute right-0 opacity-10">
            <Title />
          </h1>
        </Tween>
      )}
    ...
    <div className="grid grid-cols-8 gap-4 px-32 py-72">
      <div className="col-span-1">
        {/* <Scene triggerElement="#challenge" duration="150%" triggerHook="1">
          {progress => (
            <Tween
              to={{
                left: "-300px"
        ...
        <Scene triggerElement="#challenge" duration="120%" triggerHook="1">
          {progress => (
            <Tween
              ...
              totalProgress={progress}
              paused>
              <p className="font-main text-5xl font-extralight text-black">
                <Content />
              </p>
            </Tween>
          )}
